...
Windkessel_R  = 50.0/5 # systemic circulation resistance
Windkessel_C  = 5.0e-6/5 # systemic circulation compliance
...
num_Bulk  = 10.5e5
out_folder = f"/data.lfpn/ibraun/Code/Cardio-PINN/Synthetic_shapes/LV_mean_human/Diastolic_filling_C_R5/_a_iso{round(num_a_iso)}"
