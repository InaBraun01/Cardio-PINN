...
vtk_file = "/data.lfpn/ibraun/Code/Cardio-PINN/Synthetic_shapes/double_Maike_ES/double_Maike_ES.vtk"
...
systole_length            = 400. # length of systole [ms]
...
out_folder = f"/data.lfpn/ibraun/Code/Cardio-PINN/Synthetic_shapes/double_Maike_ES/test"
        ...
        for i in range(0,n_steps): #go through all steps in the simulation
            ...
            if not systolic_phase:
                ...
                if ejection: #when in systolic ejection
                    ...
                    pressure_LV[i] = Isovolumetric_PressureUpdate(save_volume,active_stress[i])  #update the pressure while keeping the volumne constant
