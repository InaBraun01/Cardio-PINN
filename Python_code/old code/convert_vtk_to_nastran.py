...
reader.SetFileName("/data.lfpn/ibraun/Code/Cardio-PINN/Synthetic_shapes/LV_mean_human/LV_mean_human_ESV.vtk")
reader.Update()
...
with open("/data.lfpn/ibraun/Code/Cardio-PINN/Synthetic_shapes/LV_mean_human/LV_mean_human_ESV.nas", "w") as f:
    # Write header
...
print("Created file containing vtk file converted to nastran.")
