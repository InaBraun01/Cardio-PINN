...
do
    ...
    python CardioPINN_diastole_human.py --$factor_aiso $random_float_1a --$factor_af $random_float_2a --$factor_as $random_float_3a --$factor_afs $random_float_4a --$factor_biso $random_float_1b --$factor_bf $random_float_2b --$factor_bs $random_float_3b --$factor_bfs $random_float_4b
    echo "----------------------------------------"
done
