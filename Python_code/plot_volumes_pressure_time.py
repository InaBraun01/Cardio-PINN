...
df_pV = pd.read_csv('/data.lfpn/ibraun/Code/Cardio-PINN/Synthetic_shapes/Shape1/Monkey_size_test/P_volumes.csv')

plot_function(df_pV['volume'], df_pV['pressure_LV'], index = 138, save_title= "/data.lfpn/ibraun/Code/Cardio-PINN/Synthetic_shapes/Shape1/Monkey_size_test/P_volumes.png" )
