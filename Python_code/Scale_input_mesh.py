...
# Read the original model from a VTK file
mesh = pv.read('/data.lfpn/ibraun/Code/Cardio-PINN/Test_data/LV_mean_half_scaled.vtk')

# Define the scaling factor to change the unit from m to mm
scale_factor = 1/500  # go back to unit of mm
...
scaled_mesh.save('/data.lfpn/ibraun/Code/Cardio-PINN/Test_data/LV_mean_human.vtk')
