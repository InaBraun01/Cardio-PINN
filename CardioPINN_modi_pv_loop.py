...
end_systolic_LV_pressure = 150    # end systolic left ventricular pressure value
        ...
        for i in range(0,n_steps): #go through all steps in the simulation
            ...
            if not systolic_phase:
                ...
                if ejection: #when in systolic ejection
                    ...
                    if syst_steps>15: #after three steps in systole
                        ...
                        if pressure_LV[i] <= end_systolic_LV_pressure:
                    ...
                    if pressure_LV[i] <= end_diastolic_LV_pressure/2 or active_stress[i] <= 0:
